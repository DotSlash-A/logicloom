  ...
  return (
    ...
    >
      ...
      <div className="text-balance relative z-20 mx-auto mb-4 mt-4 max-w-4xl text-center text-3xl font-semibold tracking-tight text-gray-700 dark:text-neutral-300 md:text-7xl">
        <Balancer>
          <motion.h2>
            {"Revolutionize your headlines with AI"
              .split(" ")
              .map((word, index) => (
                <motion.span
                  initial={{
      ...
      >
        "With our state-of-the-art, cutting-edge AI, your headlines are generated in seconds—always fresh, always impactful, and ready to captivate!".
      </motion.p>
      <motion.div
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
